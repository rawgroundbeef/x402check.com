...
2. View page source -- confirm only 2 script tags (jsdelivr x402check IIFE + input.js)
3. Open browser console -- confirm no errors, `window.x402Validate.validate` is a function
