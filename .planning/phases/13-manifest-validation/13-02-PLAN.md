...
must_haves:
  ...
  artifacts:
    - path: "packages/x402check/test/manifest-validation.test.ts"
  ...
  key_links:
    - from: "packages/x402check/test/manifest-validation.test.ts"
    ...
    - from: "packages/x402check/test/integration.test.ts"
      to: "packages/x402check/src/types/errors.ts"
...
@packages/x402check/test/manifest.test.ts (existing manifest detection tests -- follow same patterns)
@packages/x402check/test/integration.test.ts
@packages/x402check/test/validation/orchestrator.test.ts (follow testing patterns)
</context>
...
<task type="auto">
  ...
  <verify>
    Run `cd /Users/rawgroundbeef/Projects/x402check && pnpm --filter x402check test` -- all tests pass including new manifest-validation.test.ts
  </verify>
  <done>
...
<task type="auto">
  ...
  <verify>
    Run `cd /Users/rawgroundbeef/Projects/x402check && pnpm --filter x402check test` -- all tests pass including the updated integration test
  </verify>
  <done>
...
<verification>
1. `pnpm --filter x402check test` passes all tests (existing + new)
